...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--init_c_gain', type=float, default=0.1,
                            help='scaling factor for normal, xavier and orthogonal.')
        parser.add_argument('--verbose', action='store_true', help='if specified, print more debugging information')
        parser.add_argument('--suffix', default='', type=str, help='customized suffix: opt.name = opt.name + suffix: e.g., {model}_{netG}_size{loadSize}')

        parser.add_argument('--n_classes', default=2, type=int, help='Number of classes (an: 2, tri: 3)')
        parser.add_argument('--resnet_shortcut', default='B', type=str, help='Shortcut type of resnet (A | B)')
        parser.add_argument('--sample_size1', default=256, type=int, help='width of inputs')
        parser.add_argument('--sample_size2', default=256, type=int, help='Height of inputs')
        parser.add_argument('--sample_duration', default=512, type=int, help='Temporal duration of inputs')
        ...
        parser.add_argument('--netC', type=str, default='resnet_10', help='selects model to use for Classifier')
        parser.add_argument('--lambda_C', type=float, default=10.0, help='weight for CE loss')
        parser.add_argument('--lambda_L1', type=float, default=100.0, help='weight for L1 loss')
        parser.add_argument('--manual_seed', default=10, type=int, help='Manually set random seed')
        parser.add_argument('--n_fold', default=5, type=int, help='Number of cross validation fold')
